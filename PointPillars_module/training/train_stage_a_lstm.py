"""
Stage A — **LSTM** temporal encoder (``LSTMTemporal``).

Example (from repo root)::

    python PointPillars_module/training/train_stage_a_lstm.py --data_root data/stage_a_experiment \\
...
if __name__ == "__main__":
    ...
    ap = argparse.ArgumentParser(description="Stage A lstm-only runner")
