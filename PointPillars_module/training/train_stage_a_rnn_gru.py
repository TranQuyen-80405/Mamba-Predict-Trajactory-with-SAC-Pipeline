"""
Stage A — **GRU** RNN baseline (``MambaTemporal`` with ``backend="gru"``).

Example (from repo root)::

    python PointPillars_module/training/train_stage_a_rnn_gru.py --data_root data/stage_a_experiment \\
...
if __name__ == "__main__":
    ...
    ap = argparse.ArgumentParser(description="Stage A gru-only runner")
