...
Run from repo root with the venv active:
    python scripts/datagen/run_generate_small.py
...
sys.path.insert(0, str(REPO_ROOT / "PointPillars_module"))
...
def main() -> None:
    cfg = DataGenConfig(
        out_dir=str(REPO_ROOT / "data" / "stage_a_smoke"),
        n_scenes=10,
