...
Usage (từ thư mục gốc repo)::
    .venv\\Scripts\\python.exe tools/rgb_preview_to_png.py data/stage_a_rgb_spotcheck/s0000_r00.npz
    .venv\\Scripts\\python.exe tools/rgb_preview_to_png.py path/to/file.npz path/out.png
"""
...
from tools.rgb_preview_layout import grid_rows_cols, sample_frame_indices
